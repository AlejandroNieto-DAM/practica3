...
- Fedora/CentOS/Suse: `sudo dnf -y install SFML` o `sudo yum -y install SFML`
...
[![Abrir con Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://github.com/AlejandroNieto-DAM/practica3)
